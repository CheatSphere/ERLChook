...
local ResizeIcon = Library:GetIcon("arrow-down-right")
...
function Library:SetIconModule(module: IconModule)
    ...
    ResizeIcon = Library:GetIcon("arrow-down-right")
...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        New("UICorner", {
            CornerRadius = UDim.new(0, (Library.CornerRadius - 1) / 3),
            Parent = Picker,
        })
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        function Dropdown:BuildDropdownList()
            ...
            for _, Value in pairs(Values) do
                ...
                New("UICorner", {
                    CornerRadius = UDim.new(0, (Library.CornerRadius - 1) / 6),
                    Parent = Button,
                })
...
function Library:CreateWindow(WindowInfo)
    ...
    local function ApplySidebarLayout()
        ...
        if LayoutRefs.TitleHolder then
            LayoutRefs.TitleHolder.Size = UDim2.new(0, LayoutState.CompactWidth, 1, 0)
        end
        ...
        if LayoutRefs.WindowTitle then
            ...
            local MaxTextWidth = math.max(0, LayoutState.CompactWidth - (WindowInfo.Icon and WindowInfo.IconSize.X.Offset + 12 or 12) - 50)
            local TextWidth = Library:GetTextBounds(LayoutRefs.WindowTitle.Text, Library.Scheme.Font, 20, MaxTextWidth)
            LayoutRefs.WindowTitle.Size = UDim2.new(0, TextWidth, 1, 0)
        end

        if LayoutRefs.RightWrapper then
            local PositionX = LayoutState.CompactWidth + 8
        ...
        -- labels don't show under tab icons in compact:
        -- for _, LabelObject in ipairs(LayoutRefs.TabLabels) do
        --     LabelObject.Visible = not IsCompact
        -- end

        -- labels do show under compact mode icons:
        for _, LabelObject in ipairs(LayoutRefs.TabLabels) do
            LabelObject.Visible = true
            if IsCompact then
                LabelObject.Position = UDim2.fromOffset(0, 23)
                LabelObject.Size = UDim2.new(1, 0, 0, 20)
        ...
        -- labels show when hovered (compact mode, also see line 6651 when modifying any of these): 
        for _, LabelObject in ipairs(LayoutRefs.TabLabels) do
            if IsCompact then
    ...
    do
        ...
        local TitleHolder = New("Frame", {
            BackgroundTransparency = 1,
            Position = UDim2.fromOffset(12, 0), -- right offset i eyeballed 12 idk
        ...
        New("UIListLayout", {
            ...
            Padding = UDim.new(0, 2), -- offset of icon to window title
            Parent = TitleHolder,
        })
        ...
        local RightWrapper = New("Frame", {
            ...
            Position = UDim2.new(0, InitialSidebarWidth - 30, 0.5, 0),
...
--[[
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Size = UDim2.new(0, InitialSidebarWidth - 4,1,-24),
            Parent = MainFrame,
        })
        New("UIListLayout", {
            Parent = Tabs,
    ...
    function Window:AddTab(...)
        ...
        do
            ...
            local ButtonPadding = New("UIPadding", {
                PaddingBottom = UDim.new(0, LayoutState.IsCompact and 7 or 11),
                PaddingLeft = UDim.new(0, LayoutState.IsCompact and 23), -- or 12),
                PaddingRight = UDim.new(0, LayoutState.IsCompact and 23), -- or 12),
                PaddingTop = UDim.new(0, LayoutState.IsCompact and 7 or 11),
                Parent = TabButton,
            })
            ...
            TabLabel = New("TextLabel", {
                BackgroundTransparency = 1,
                Position = UDim2.fromOffset(Icon and 40 or 30, 0),
                Size = UDim2.new(1, Icon and -40 or -30, 1, 0),
                Text = Name,
                TextSize = 16,
                TextTransparency = 0.5,
                TextXAlignment = Enum.TextXAlignment.Left,
                Visible = true, -- make Visible = not LayoutState.IsCompact, if not using show when compact!!!!
                --Visible = not LayoutState.IsCompact,
                Parent = TabButton,
            })
            table.insert(LayoutRefs.TabLabels, TabLabel)

            -- delete this when not using show tab name on hover thing
        ...
        function Tab:Hover(Hovering)
            ...
            if Highlight2 then
                TweenService:Create(Highlight2, Library.TweenInfo, {
    ...
    function Library:Toggle(Value: boolean?)
        ...
        MainFrame.Visible = Library.Toggled --// note: if want to add some window anim in future change this maybe idk im just guessing
